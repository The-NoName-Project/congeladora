                ...
                <div class="card-body mt-auto">
                    <div class="row">
                        @foreach($soccer as $match)
                            <a href="{{ route('matches.show', Vinkla\Hashids\Facades\Hashids::encode($match->id) ) }}" style="text-decoration: none; color: #0e1014" class="col-md-4">
                                <div class="card d-flex align-items-center bg-primary-subtle">
                                    <div class="card-body">
                                        ...
                                        <label class="badge badge-info">
                                            Faltan {{ Carbon::now()->diff($match->match_date)->format('%d días') }} para el partido.
                                        </label>
                                    </div>
                                </div>
                            </a>
