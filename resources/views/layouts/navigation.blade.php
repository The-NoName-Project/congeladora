<div class="md:fixed md:w-full md:top-0 md:z-20 flex flex-row flex-wrap items-center bg-dark p-6 border-b border-gray-300">
    <div class="flex-none w-56 flex flex-row items-center">
        <img src="{{ asset('assets/img/logo.png') }}" class="w-10 flex-none" alt="">
    ...
    <div id="navbar" class="animated md:hidden md:fixed md:top-0 md:w-full md:left-0 md:mt-16 md:border-t md:border-b md:border-gray-200 md:p-10 md:bg-white flex-1 pl-3 flex flex-row flex-wrap justify-between items-center md:flex-col md:items-center">
        ...
        <div class="flex flex-row-reverse items-center">
            <div class="dropdown relative md:static">
                ...
                <div class="text-gray-500 menu hidden md:mt-10 md:w-full rounded bg-gray-800 shadow-md absolute z-20 right-0 w-40 mt-5 py-2 animated faster">
                    <a class="px-4 py-2 block capitalize font-medium text-sm rounded tracking-wide bg-dark hover:bg-gray-900 hover:text-gray-200 transition-all duration-300 ease-in-out" href="#">
                        <i class="fad fa-user-edit text-xs mr-1"></i>
                        edit my profile
                    </a>
                    <a class="px-4 py-2 block capitalize font-medium text-sm tracking-wide bg-dark hover:bg-gray-900 hover:text-gray-200 transition-all duration-300 ease-in-out" href="#">
